...
sub game_loop {
    ...
    SDL::GFXHlineRGBA( $surf, 0, $surfWidth, $surfMidHeight, 255, 255, 255,
        255 );

    SDL::GFXVlineRGBA( $surf, $surfMidWidth, 0, $surfHeight, 255, 255, 255,
        255 );
    ...
    SDL::GFXAalineRGBA( $surf, $surfWidth, 0, 0, $surfHeight, 0, 255, 255,
        255 );
    ...
    # pie slices
    SDL::GFXFilledPieRGBA( $surf, $surfMidWidth, $surfMidHeight,
        $surfMidWidth * .1,
        0, 90, 0, 0, 255, 255 );

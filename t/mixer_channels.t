...
my $fading_channels =
  SDL::Mixer::Channels::fade_out_channel( $playing_channel, $delay );
...
$playing_channel =
  SDL::Mixer::Channels::fade_in_channel( -1, $sample_chunk, 0, $delay );
isnt( $playing_channel, -1,
...
$playing_channel =
  SDL::Mixer::Channels::play_channel_timed( -1, $sample_chunk, 0, $delay );
isnt( $playing_channel, -1,
    "[play_channel_timed] play $delay ms for channel $playing_channel" );
SDL::delay( $delay / 4 );
my $expire_channel =
  SDL::Mixer::Channels::expire_channel( $playing_channel, $delay );
is( $expire_channel > 0,
    1,
...
$playing_channel =
  SDL::Mixer::Channels::fade_in_channel_timed( -1, $sample_chunk, 0, $delay,
    $delay * 2 );
isnt( $playing_channel, -1,
        "[fade_in_channel_timed] play "
      . ( $delay * 2 )
      . " ms after $delay ms fade in for channel $playing_channel" );

isa_ok( SDL::Mixer::Channels::get_chunk($playing_channel),

...
my $text =
'Hi <b><span foreground="red"><i>k</i></span>thakore</b> its me, <u>Pango</u>!!';

SDL::Pango::set_default_color( $context, 0xA7C344FF, 0 );
pass "[set_default_color] ran";
SDL::Pango::set_default_color( $context, 0xA7, 0xC3, 0x44, 0xFF, 0, 0, 0,
    0x00 );
pass "[set_default_color] ran";
...
SKIP:
{
    ...
    SDL::Pango::set_surface_create_args( $context, SDL_SWSURFACE, 32, 255 << 24,
        255 << 16, 255 << 8, 255 );
    ...
    SDL::Video::blit_surface( $surface, SDL::Rect->new( 0, 0, 640, 480 ),
        $display,

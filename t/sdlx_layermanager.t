...
isa_ok( $manager->layers_ahead($manager->layer(0)),          'ARRAY',              'SDLx::LayerManager->layers_ahead' );
isa_ok( @{$manager->layers_ahead($manager->layer(0))}[0],    'SDLx::Layer',        'SDLx::LayerManager->layers_ahead[]' );
is    ( @{$manager->layers_ahead($manager->layer(0))}[0]->h, 120,                  'SDLx::LayerManager->layers_ahead->h' );

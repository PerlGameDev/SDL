...
SKIP:
{
    ...
    isa_ok( SDL::Image::load("test/data/picture.jpg"),
        "SDL::Surface", "[load] Gets Surface" );
    ...
    isa_ok( SDL::Image::load_typed_rw( $file2, 1, "JPG" ),
...
SKIP:
{
    ...
    isa_ok( SDL::Image::load("test/data/picture.tif"),
        "SDL::Surface", "[load] Gets Surface" );
    ...
    isa_ok( SDL::Image::load_typed_rw( $file2, 1, "TIF" ),

...
it will load the default C<Tuffy> free font (see "L</"COPYRIGHT & LICENSE">".
...
This module ships with a default font, "I<Tuffy>", released to public domain by Thatcher Ulrich (http://tulrich.com).

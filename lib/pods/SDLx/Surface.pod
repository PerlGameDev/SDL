...
=head2 blit 
 ...
 $sdlx_surface->blit( $src_rect, $dest, $dest_rect );

Blits SDLx::Surface onto $dest surface. $src_rect or $dest_rect can be array refs or SDL::Rect. $dest can be SDLx::Surface or SDL::Surface. 

...
printing, so you are responsible for line spacing, see the L<SDL::TTF::font_line_skip> as well.
...
Get the recommended pixel height of a rendered line of text of the loaded font. This is usually larger than the L<SDL::TTF::font_height> of the 
font.
...
is done to get the actual width. The height returned is the same as you can get using L<SDL::TTF::font_height>.
...
done to get the actual width. The height returned in h is the same as you can get using L<SDL::TTF::font_height>.
...
is done to get the actual width. The height returned in h is the same as you can get using L<SDL::TTF::font_height>.

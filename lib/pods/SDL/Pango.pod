...
Sets the argumet that are used when creating a surface via L<SDL::Pango::create_surface_draw>.
...
Creates a new surface and draws the text/markup. You can specify the attributes of the surfaces using L<SDL::Pango::set_surface_create_args>.

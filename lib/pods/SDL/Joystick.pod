...
Returns the C<index> of a given C<SDL_Joystick> structure. See L<SDL::Joystick::open|/open>

=head2 num_axes

 int SDL::Joystick::num_axes( object );

Return the number of axes available from a previously opened joystick. See L<SDL::Joystick::open|/open>

=head2 num_balls

 int SDL::Joystick::num_balls( object );

Return the number of trackballs available from a previously opened joystick. See L<SDL::Joystick::open|/open>

=head2 num_hats

 int SDL::Joystick::num_hats( object );

Gets the number of joystick hats from a previously opened joystick. See L<SDL::Joystick::open|/open>

=head2 num_buttons

 int SDL::Joystick::num_buttons( object );

Gets the number of joystick buttons from a previously opened joystick. See L<SDL::Joystick::open>
...
Closes a previously opened joystick. See L<SDL::Joystick::open|/open>
